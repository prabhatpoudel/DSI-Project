...
@echo xcopy /y /f "\\vmware-host\Shared Folders\Projects\FileLoad\IM.csv" "Forecast\" >> process.log
xcopy /y /f "\\vmware-host\Shared Folders\Projects\FileLoad\IM.csv" "Forecast\"
@echo xcopy /y /f "\\vmware-host\Shared Folders\Projects\FileLoad\WNA.csv" "Forecast\" >> process.log
xcopy /y /f "\\vmware-host\Shared Folders\Projects\FileLoad\WNA.csv" "Forecast\"
...
@echo Running: sqlldr ifsapp/ifsapp@ifsapp8sp1_race ifsapp8sp1_race.ctl >> process.log

sqlldr ifsapp/ifsapp@ifsapp8sp1_race load_forecast_file.ctl
